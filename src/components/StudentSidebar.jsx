...
const navItems = [
  ...
  { to:"/student/fees",        label:"Fees",
    svg:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{width:17,height:17}}><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> },
  { to:"/student/notices",     label:"Notices",
    svg:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{width:17,height:17}}><path d="M18 8h1a4 4 0 0 1 0 8h-1"/><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"/></svg> },
  ...
  { to:"/student/timetable",   label:"Timetable",
    svg:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={{width:17,height:17}}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><line x1="3" y1="16" x2="21" y2="16"/></svg> },
];
...
export default function StudentSidebar({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* ✅ Same as Admin sidebar — #1a1f37 background */}
      <aside className={`sidebar-transition ${isOpen ? "open-sidebar" : ""}`}
        ...
        <div style={{ display:"flex", alignItems:"center", gap:10, padding:"18px 16px 14px", borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
          ...
          <div style={{ flex:1, minWidth:0 }}>
            ...
            <p style={{ color:"#475569", fontSize:11, margin:0 }}>Student Panel</p>
          </div>
        ...
        {/* Student Mini Profile — same style as admin */}
        <div style={{ margin:"10px 10px 4px", padding:"11px 12px", borderRadius:12, background:"rgba(255,255,255,0.05)", border:"1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            ...
            <div style={{ minWidth:0 }}>
              ...
              <p style={{ color:"#475569", fontSize:10, margin:0 }}>Class 10-A • Roll 12</p>
            </div>
          </div>
        </div>

        {/* Nav — same active style as admin */}
        ...
        <div style={{ margin:"0 10px 14px", padding:"14px", borderRadius:14, background:"rgba(79,70,229,0.15)", border:"1px solid rgba(99,102,241,0.25)", textAlign:"center" }}>
          ...
          <p style={{ color:"#fff", fontSize:12, fontWeight:700, margin:0 }}>Student Portal</p>
