                      ...
                      <tr key={s._id}
                        ...
                        <td style={{ padding:"12px 14px" }}>
                          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                            {s.image
                              ? <img src={`http://localhost:5000${s.image}`} style={{ width:30, height:30, borderRadius:"50%", objectFit:"cover" }}/>
              ...
              {paginated.map((s,i)=>(
                <div key={s._id} style={{ background:"var(--bg-input)", borderRadius:12, padding:"14px 16px", border:"1px solid var(--border)" }}>
                  <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:10 }}>
                    <div style={{ display:"flex", alignItems:"center", gap:10 }}>
                      {s.image
                        ? <img src={`http://localhost:5000${s.image}`} style={{ width:36, height:36, borderRadius:"50%", objectFit:"cover" }}/>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8, marginBottom:12 }}>
                    {[{label:"Class",val:s.class},{label:"Phone",val:s.phone||"N/A"}].map(d=>(
                      <div key={d.label} style={{ background:"var(--bg-card)", borderRadius:8, padding:"8px 10px", border:"1px solid var(--border)" }}>
                        ...
                        <p style={{ fontSize:13, color:"var(--text-primary)", fontWeight:500, margin:0 }}>{d.val}</p>
                      </div>
                    ))}
                  </div>
